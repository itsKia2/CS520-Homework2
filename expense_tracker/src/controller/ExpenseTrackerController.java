...
public class ExpenseTrackerController {
    ...
    /**
     * Refreshes the view with latest transactions (all)
     */
    public void refresh() {
    ...
    /**
     * If the input is valid (amount or category), adds it as a transaction
     *
     * @param amount dollar amount of transactions
     * @param category which category (predefined)
     * @return true if transaction was added to list
     **/
